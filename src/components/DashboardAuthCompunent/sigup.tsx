...
import { creatUser } from '@/action/action';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-slate-100 flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <form action={creatUser} className="space-y-6">
          {/* Name Input */}
          <div className="relative">
            ...
            {formErrors.name && (
              <p className="text-red-500 text-xs mt-1 pl-10">{formErrors.name}</p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            {formErrors.email && (
              <p className="text-red-500 text-xs mt-1 pl-10">{formErrors.email}</p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            {formErrors.password && (
              <p className="text-red-500 text-xs mt-1 pl-10">{formErrors.password}</p>
            )}
          </div>
